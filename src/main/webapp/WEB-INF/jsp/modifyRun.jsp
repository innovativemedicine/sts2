...
<form method="post">
	<table class="table">
		...
		<tr>
			<td>Run Date:</td>
			<td><spring:bind path="command.runDate">
					<INPUT type="text" maxlength="255" size="30" name="date"
						value="<c:out value="${status.value}"/>">
				</spring:bind></td>
		</tr>
		...
		<tr>
			<td>Test(s):</td>
			<td><c:out value="${command.testNameList}" /><br> <select
				name="testIds" size="5" multiple>
		...
		<tr>
			<td>Plate(s):</td>
			<td><c:out value="${command.plateNameList}" /><br> <select
				name="plateIds" size="5" multiple>
