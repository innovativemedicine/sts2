...
<table class="table table-bordered table-condensed small-list">
	<tr class="info">
		...
		<td class="span1"><b>Birth<br>Date
		</b><br>
		<span class="small-list-details">YYYY-MM-DD</span></td>
		<td class="span1"><b>Received<br> Date
		</b><br>
		<span class="small-list-details">YYYY-MM-DD</span></td>
		<td class="span1"><b>Note</b></td>
	</tr>
	...
	<c:forEach items="${sampleList}" var="sample">
		<tr>
    		...
    		<c:param name="sampleId" value="${sample.sampleId}"/></c:url>"><c:out
							value="${sample.sampleType.suffix}-${sample.sampleDupNo}" /></a></td>
