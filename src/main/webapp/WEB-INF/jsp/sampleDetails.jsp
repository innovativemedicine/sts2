...
<tr>
	<td><%@ include file="/WEB-INF/jsp/includes/success.jsp"%>
		<p></p>
			...
			<font style="vertical-align: bottom" size="5"> Sample Details
			</font> <a class="button"
		...
		<table>
			<tr>
					...
					<table class="details">
						...
						<tr>
							<td colspan="2" align="center"><a id="expander" href="#"
								onclick='expandable();'>[Show Concentration]</a>
							</td>
						</tr>
					</table>
				...
				<td>
						<table id="expandable" class="details" style="display: none;">
							<tr>
		...
		<table class="details">
			...
			<c:forEach items="${command.samplesInContainersOut}"
				var="siContainer">
