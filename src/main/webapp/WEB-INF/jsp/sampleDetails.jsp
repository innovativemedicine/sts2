	...
	<div class="span4">
		<div class="alert alert-info">
			Patient Information <a class="btn btn-mini pull-right"
				href="<c:url value="/editPatient.htm"><c:param name="intSampleId" value="${command.patient.intSampleId}"/></c:url>"><i
				class="iconic-pen-alt2"> EDIT</i></a>
		</div>
		...
		<table class="table">
			...
			<c:forEach items="${command.samplesInContainersIn}" var="siContainer">
				...
				<tr>
					...
					<td>
						<c:out value="${siContainer.container.containerType.name}" />
					</td>
					<td>
