...
<h2>Edit Sample: <c:out value="${command.patient.intSampleId}"/>-<c:out value="${command.sampleType.suffix}"/>-<c:out value="${command.sampleDupNo}"/> </h2>
<form method="post">
	<div class="row-fluid">
		<div class="span4">
			...
			<div class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="controls">
						<input required class="input-medium" type="text"
				...
				<div class="control-group">
					...
					<div class="controls">
						<spring:bind path="command.sampleType">
							<input disabled type="text" class="input-small"
								value="<c:out value="${command.sampleType}"/>" />
						</spring:bind>
						<spring:bind path="command.sampleDupNo">
							<input disabled type="text" class="input-micro"
								value="<c:out value="${command.sampleDupNo}"/>" />
						</spring:bind>
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<spring:bind path="command.receiveDate">
							<input class="input-medium" type="text" placeholder="DD-MM-YYYY"
								name="receiveDate"
				...
				<div class="control-group">
					...
					<div class="controls">
						<spring:bind path="command.notes">
							<input class="input-medium" type="text" name="notes"
								value="<c:out value="${status.value}"/>">
						</spring:bind>
					</div>
				</div>
					...
					<div class="controls">
						<div class="input-append span5">
							<spring:bind path="command.od">
								<input class="input-mini" type="text" name="od"
									value="<c:out value="${status.value}"/>">
							</spring:bind>
					...
					<div class="controls">
						<div class="input-append span5">
							<spring:bind path="command.volumn">
								<input class="input-mini" type="text" name="volumn"
									value="<c:out value="${status.value}"/>">
						...
						<spring:bind path="command.volumnDate">
							<input class="input-small" type="text" placeholder="DD-MM-YYYY"
								name="volumnDate"
								pattern="(0[1-9]|[12][0-9]|3[01])[-](0[1-9]|1[012])[-](19|20|21)\d\d"
								value="<c:out value="${status.value}"/>">
						</spring:bind>
